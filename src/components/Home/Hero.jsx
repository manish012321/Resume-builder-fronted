    ...
    <>
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    ...
                    <div className="hidden md:flex items-center gap-8 transition duration-500 text-slate-600">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Link to='/app' className='hidden md:block px-8 py-2 border active:scale-95 hover:bg-green-100 transition-all rounded-full text-green-700 hover:text-green-900' hidden={!user}> 
                        Dashboard
                        </Link>
                    </div>
